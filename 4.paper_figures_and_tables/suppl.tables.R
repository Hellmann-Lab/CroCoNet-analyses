...
experiments_and_cell_lines <- data.frame(species = c(rep("human", 7),
                                         ...
                                         sex = c("M", "M", "M", "F", "F", "M", "F", "M", "M", "M", "F", "F", "F", "F", "F", "F", "F"),
                                         primary_material = c(rep("urine-derived stem cell", 5),
                                                              "peripheral blood mononuclear cell",
                                                              rep("urine-derived stem cell", 4),
                                                              rep("dermal fibroblast", 7)),
                                         provider_of_primary_material = c(rep("human donor", 7),
                                                                          rep("Hellabrunn Zoo, Munich, Germany", 3),
                                                                          rep("PELOBiotech, Planegg, Germany", 7)),
                                         reprogramming_method = rep("integration-free Sendai virus-based OSKM vectors", 17),
                                         provider_of_cell_line = c(rep("in-house", 5),
                                                                   "Center for iPS Cell Research and Application (CiRA), Kyoto, Japan",
                                                                   rep("in-house", 11)),
                                         publication = c("Geuder et al., 2021 [79]",
                                                         "Geuder et al., 2021 [79]",
                                                         "Edenhofer et al., 2024 [82]",
                                                         "Geuder et al., 2021 [79]",
                                                         "this paper",
                                                         "Sasaki et al. 2015 [78]",
                                                         "Edenhofer et al., 2024 [82]",
                                                         "Geuder et al., 2021 [79]",
                                                         "Geuder et al., 2021 [79]",
                                                         "Edenhofer et al., 2024 [82]",
                                                         "Kliesmete et al. 2023 [80]",
                                                         "this paper",
                                                         "Edenhofer et al., 2024 [82]",
                                                         "Edenhofer et al., 2024 [82]",
                                                         "Kliesmete et al. 2024 [81]",
                                                         "Edenhofer et al., 2024 [82]",
                                                         "Edenhofer et al., 2024 [82]")) %>% 
  dplyr::mutate(scRNA_seq = ifelse(clone %in% c("H1c1", "H2c1", "H3c1", "G1c1", "G1c2", "C1c1", "C1c2", "C2c1", "C2c2"), "✔", NA),
                ...
                genotype = ifelse(clone %in% c("H1c3", "H4c1", "C1c4", "C2c3"), "KRAB-dCas9-HA-P2A-mCherry insertion", "wild type"),
                .after = 5)
