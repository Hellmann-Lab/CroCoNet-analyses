...
output_dir <- here("data/neural_differentiation_dataset/CroCoNet_analysis_top50/")
fig_dir <- here(output_dir, "figures/")
...
# consensus network
consensus_network <- readRDS(here(input_dir, "consensus_network.rds"))

# replicate-wise networks
network_list <- readRDS(here(input_dir, "network_list.rds"))

# list of regulators
regulators <- readRDS(here(input_dir, "regulators.rds"))

# initial modules
initial_modules <- readRDS(here(input_dir, "initial_modules.rds"))
...
saveRDS(pruned_modules, here(output_dir, "pruned_modules_top50.rds"))

# random modules
random_modules <- createRandomModules(pruned_modules, genes)
saveRDS(random_modules, here(output_dir, "random_modules_top50.rds"))
